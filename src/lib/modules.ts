...
export const MODULE_GROUPS: { label: string; items: AppModule[] }[] = [
  {
    ...
    items: [
      ...
      { key: 'invoicing', title: 'GST Billing & Invoicing', desc: 'GST-compliant invoices with CGST/SGST/IGST and payment tracking.', icon: 'FileText', status: 'live', href: '/invoices' },
      { key: 'inventory', title: 'Inventory Management', desc: 'Track stock levels, value and low-stock reorder alerts.', icon: 'Boxes', status: 'live', href: '/inventory' },
      { key: 'retail-loans', title: 'Retail Loans', desc: 'Track loans and borrowers with automatic EMI calculation.', icon: 'Landmark', status: 'live', href: '/loans' },
      { key: 'whatsapp', title: 'WhatsApp Automation', desc: 'Auto-notify clients on filings & due dates — fully editable, from your business number.', icon: 'MessageCircle', status: 'live', href: '/whatsapp' },
